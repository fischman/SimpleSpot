...
async function processAuthCode(code, clearUrl = false, reload = false) {
  ...
  const clientId = getClientId();
  const redirectUri = getRedirectUri(localStorage.getItem('chosen_client'));
